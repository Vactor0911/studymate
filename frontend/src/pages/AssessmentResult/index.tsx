...
const AssessmentResult = () => {
  ...
  const [selections] = useState([
    { content: "선택지 1", isUserSelect: false, isAnswer: true },
    { content: "선택지 2", isUserSelect: false, isAnswer: false },
    { content: "선택지 3", isUserSelect: true, isAnswer: false },
    { content: "선택지 4", isUserSelect: false, isAnswer: false },
    { content: "선택지 5", isUserSelect: false, isAnswer: false },
  ]);
